 ...
 */
contract ListaToken is OFT, IERC2612 {
    // --- ERC20 Data ---

    string internal constant _NAME = "Lista Governance Token";
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "LISTA: expired deadline");
        ...
        require(recoveredAddress == owner, "LISTA: invalid signature");
