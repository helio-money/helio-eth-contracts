...
contract DebtToken is OFT {
    ...
    // --- Addresses ---
    IListaCore private immutable _listaCore;
    ...
    // --- Functions for intra-Lista calls ---
    ...
    function flashLoan(
        ...
        _transfer(address(receiver), _listaCore.feeReceiver(), fee);
        return true;
    }
