...
/**
    @notice Lista Curve Factory
    @title Deploys clones of `CurveDepositToken` as directed by the Lista DAO
 */
contract CurveFactory is ListaOwnable {
    ...
    /**
        @dev After calling this function, the owner should also call `Vault.registerReceiver`
             to enable LISTA emissions on the newly deployed `CurveDepositToken`
     */
